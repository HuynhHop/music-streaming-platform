...
const fs = require("fs");
const path = require("path");
const ETypeRole = require("../../shared/enums/ETypeRole");

// Đọc private key
const privateKeyPath = path.join(__dirname, "../services/private.pem");
const privateKey = fs.readFileSync(privateKeyPath, "utf8");
...
const verifyAccessToken = (req, res, next) => {
  try {
    const certPath = path.join(__dirname, "../services/publickey.crt");
